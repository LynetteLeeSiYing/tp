...
| **Export** | `export`                                                                                                                                                                                                                            |
| **Filter** | `filter [ap/APPOINTMENT_DATE_LOWER_BOUND - APPOINTMENT_DATE_UPPER_BOUND] [b/AGE_LOWER_BOUND - AGE_UPPER_BOUND]`<br> e.g. `filter b/70-99 ap/01/01/2025 - 01/01/2026`                                                                |
